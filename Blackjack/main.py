...
winFont = pygame.font.Font("symtext/Symtext.ttf", 50)
...
while running: 
    ...
    if player_stand == True and player_hand > 21:
        screen.blit(winFont.render("Dealer Wins", False, (255, 255, 255)), (200, 225))
    if player_stand == True and player_hand <= 21:
